...
This project prioritizes deterministic behavior, readable music‑theory logic, and performance‑safe MIDI output.  It is intended to be used in Emnyeca/EMN Records Emachine‑jazz sessions and Embient events, but the code may be adapted for other live harmony generation setups.
