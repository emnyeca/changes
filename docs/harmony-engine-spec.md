...
## Register and realization

### Chord

- register: MIDI `48..69`（Digitone display `C4..A5`）
...
- register: MIDI `31..42`（Digitone display `G2..F#3`）
...
- `src/changes/rendering/timeline_renderer.py`
